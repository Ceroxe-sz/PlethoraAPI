...
import asia.ceroxe.exceptions.FileNotFoundException;
import asia.ceroxe.exceptions.IncorrectTypeException;
...
public class BufferedFile extends File {
    ...
    private static boolean checkDirLegitimacy(File dir) {
        ...
        if (!dir.exists()) {
            asia.ceroxe.exceptions.FileNotFoundException.throwException(dir);
            return false;
        }
        return true;
    }
    ...
    private static boolean checkFileLegitimacy(File file) {
        ...
        if (!file.exists()) {
            asia.ceroxe.exceptions.FileNotFoundException.throwException(file);
            return false;
        }
        return true;
    }
    ...
    public BufferedFile copyAs(File destFile) {
        try {
            if (this.exists()) {
                ...
                asia.ceroxe.exceptions.FileNotFoundException.throwException(this);
                return null;
            }
        } catch (Exception e) {
            e.printStackTrace();
